...
void SinglyLL :: DeleteFirst()
{
    ...
    if(this->first == NULL)            // if(iCount == 0)
    {
        return;
    }
...
int main()
{
    ...
    while(iChoice != 9)
    {
        ...
        cout<<"3 : Insert node at Gievn Position\n";
        ...
        switch(iChoice)
    {
        ...
        case 8:
            cout<<"Number elements present in the linked list are : \n";
            sobj.Count();
            break;
            
        case 9:
            cout<<"<<<<Thank you for Marvellous Infosystem Application>>>>";    
            break;
