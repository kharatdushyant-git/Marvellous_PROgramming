...
def DirectoryScanner(DirectoryPath):
    ...
    if(Ret == False):
        print("Marvellous Automation Error : Its not a Directory ",DirectoryPath)
        

    print("Log File gets created by name as : ",LogFileName)
    ...
    fobj.write(f"Total Empty Found and Deleted : {EmptyFiles}\n")
